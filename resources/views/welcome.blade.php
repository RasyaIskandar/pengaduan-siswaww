                        ...
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            @else
                                ...
                                <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                                    class="rounded-md px-3 py-2 text-gray-500 ring-1 ring-transparent transition hover:text-black/100 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    type="button">
                                    Login
                                </button>
